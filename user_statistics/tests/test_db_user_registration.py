...
class UserRegistrationDBTest(TestCase):
    ...
    def setUp(self):
        ...
        UserRegistration.objects.create(user_name="4321", creation_time="2014-02-22T16:14:30Z")
    ...
    def test_code_has_name(self):
        ...
        self.assertEqual('2014-02-22 16:14:30', phyllisu.creation_time.strftime('%Y-%m-%d %H:%M:%S'))       
                
    def test_dict(self):
        expected_map = {'1234': '2014-02-16 23:21:59', '4321': '2014-02-22 16:14:30'}
